...
class TesContainer(unittest.TestCase):
    ...
    def test_list_favourite_musicians(self) -> None:
    ...
    def test_show_geographical_info(self) -> None:
    ...
    def test_show_self_info(self) -> None:
        self.assertEqual(
    ...
    def test_show_favourite_tunes(self) -> None:
        self.assertEqual(
