...
class TestBasic(unittest.TestCase):
    ...
    def test_return_three_strings(self) -> None:
    ...
    def test_judge_num_1(self) -> None:
    ...
    def test_judge_num_2(self) -> None:
    ...
    def test_print_remainder(self) -> None:
