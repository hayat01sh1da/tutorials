...
class TesStrings(unittest.TestCase):
    ...
    def test_words_to_sentence(self) -> None:
    ...
    def test_combine_words(self) -> None:
    ...
    def test_slice_sentence(self) -> None:
